...
a1 _ lm(us.tmp$inc ~ prep96 + pperot96);
demographics$inc _ a1$residuals;

a1 _ lm(us.tmp$cen00.native/us.tmp$cen00.population ~ prep96 + pperot96);
demographics$cen00.native _ a1$residuals;

a1 _ lm(us.tmp$cen00.asian/us.tmp$cen00.population ~ prep96 + pperot96);
demographics$cen00.asian _ a1$residuals;

a1 _ lm(us.tmp$college ~ prep96 + pperot96);
demographics$college _ a1$residuals;

a1 _ lm(us.tmp$cen00.black/us.tmp$cen00.population ~ prep96 + pperot96);
demographics$cen00.black _ a1$residuals;

a1 _ lm(us.tmp$cen00.hispanic/us.tmp$cen00.population ~ prep96 + pperot96);
demographics$cen00.hispanic _ a1$residuals;

a1 _ lm(us.tmp$cen00.white/us.tmp$cen00.population ~ prep96 + pperot96);
demographics$cen00.white _ a1$residuals;

a1 _ lm(density ~ prep96 + pperot96);
demographics$densityUP _ a1$residuals;

a1 _ lm(us.tmp$cen00.population ~ prep96 + pperot96);
